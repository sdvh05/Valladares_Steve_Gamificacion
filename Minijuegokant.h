#ifndef MINIJUEGOKANT_H
#define MINIJUEGOKANT_H
...
public:
    explicit MinijuegoKant (Personaje* jugadorExistente, QWidget* parent = nullptr, int Actual=0);
